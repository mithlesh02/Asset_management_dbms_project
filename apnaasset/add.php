...
<?php
            ...
            if(empty($_POST['add_asset'])===false) {
                ...
                $reuired_fields = array('name', 'department', 'quantity', 'price','location','perishable','vendorname','purchasedate');
                ...
                <table border=0>
                    <tr>
                        <td id='label-col'>
                            <label>Name*</label> </td>
                        <td id='input-col'>
                            <input type='text' name='name' required maxlength=30 > </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td id='input-col'>
                            <input type='text' name='department' required maxlength=30 > </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td id='input-col'>
                            <input type='text' name='location' required maxlength=30 > </td>
                    </tr>
                    ...
                    <tr>
                        <td id='label-col'>
                            <label>Vendorname*</label> </td>
                        <td id='input-col'>
                            <input type='text' name='vendorname' required  > </td>
                    </tr>    

                    <tr>
                        <td id='label-col'>
                            <label>Purchasedate*</label> </td>
                        <td id='input-col'>
                            <input type='text' placeholder="yyyy-mm-dd" name='purchasedate' required > </td>
                    </tr>
